...
export default {
  setup() {
    onMounted(() => {
      console.log('DecoupledDocumentEditor:', DecoupledDocumentEditor.create);
      
      DecoupledDocumentEditor.create(document.querySelector( '.document-editor__editable'), {
        // plugins: [ TextPartLanguage ],
        // toolbar: [ 'textPartLanguage', ...DecoupledDocumentEditor.defaultConfig ],
        language: {
          ui: 'en',
          content: 'ar'
        }
        ...
        console.log('con：', toolbarContainer);
